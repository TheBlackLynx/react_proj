...
import { getArticlesPageError, getArticlesPageHasMore, getArticlesPageIsLoading, getArticlesPagePage, getArticlesPageView } from '../../model/selectors/articlesPageSelectors';
...
const article = {
  ...
  user: {
    id: 1,
    login: 'marica',
    avatar: 'https://99px.ru/sstorage/1/2022/12/image_12812221040495159998.jpg'
  },
  type: [
    "IT"
  ],
