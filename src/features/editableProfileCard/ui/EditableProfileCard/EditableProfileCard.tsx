...
export const EditableProfileCard = memo((props: EditableProfileCardProps) => {
    ...
    const validateErrorTranslates = {
        ...
        [ValidateProfileError.INCORRECT_AGE]: t('Неверный формат возраста'),
        [ValidateProfileError.INCORRECT_AGE_LENGTH]: t(
            'Значение возраста не может превыщать 3 символов',
        ),
        [ValidateProfileError.NO_DATA]: t('Данные не указаны'),
        [ValidateProfileError.INCORRECT_USER_DATA]: t(
            'Логин и имя пользователя обязательны при сохранении',
        ),
